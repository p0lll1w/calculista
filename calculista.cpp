...
int main()
{
	...
	string usuario;
	string senha;
	cout << "insira seu nome de usuario e sua senha" << endl << endl;
	cin >> usuario;
	cin >> senha;
	if(usuario == "pevai" && senha == "senhafoda123") {
		cout << endl << "acesso concedido" << endl << endl;
		acesso = true;
	}
	else {
	...
	if(acesso) {
		char op;
		cout << "bem-vindo a calculista, " << usuario << "!" << endl;
